...
/**
 * Throws by anything that expect correct login details but got instead wrong 
 * ones, either caused by a non-existing username or by a non-matching password.
 * 
 * @author Louis-Marie Matthews
 * @version 1.0
 */
public class WrongLoginDetailsException
  extends Exception
{
